...
public class DashboardSoporte extends JDialog {
    ...
    private void accionAsignarTecnico() {
        ...
        ArrayList<Empleado> empleados = EmpresaAltice.getInstance().getMisEmpleados();
        if (empleados.isEmpty()) {
            JOptionPane.showMessageDialog(this, "No hay empleados registrados.", "Error", JOptionPane.ERROR_MESSAGE);
            return;
        }
